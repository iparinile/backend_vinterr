...
def get_routes(config: ApplicationConfig, context: Context) -> Tuple:
    return (
        ...
        endpoints.CustomerEndpoint(config=config, context=context, uri='/customers/<customer_id:int>',
                                   methods=['GET', 'PATCH', 'OPTIONS'], auth_required=True),
        ...
        endpoints.UpdateRemainsEndpoint(config=config, context=context, uri='/variations/update_remains',
                                        methods=['POST', 'OPTIONS'],
                                        auth_required=True, is_administrator_access=True),
        endpoints.AutoUpdateRemainsEndpoint(config=config, context=context, uri='/variations/auto_update_remains',
                                            methods=['POST', 'OPTIONS'],
                                            auth_required=True, is_administrator_access=True),
        endpoints.UpdateWeightsEndpoint(config=config, context=context, uri='/goods/update_weights',
                                        methods=['POST', 'OPTIONS'],
                                        auth_required=True, is_administrator_access=True),
        endpoints.ImageEndpoint(config=config, context=context, uri='/images/<img_path:path>',
                                methods=['GET']),
        endpoints.ImageEndpoint(config=config, context=context, uri='/images/<img_path:path>',
                                methods=['DELETE'], auth_required=True, is_administrator_access=True),
